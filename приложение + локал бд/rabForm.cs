    ...
    public partial class rabForm : Form
    {
       ...
       */
        ...
        */
        ...
        private void rabForm_Load(object sender, EventArgs e)
        {
            DB db = new DB();
            ...
            MySqlCommand command = new MySqlCommand("Select * From rabota", db.getConnection());
        ...
        public Boolean checkUser()
        {
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            // Формирование запроса
            MySqlCommand command = new MySqlCommand("Select * From rabota Where name_rab = @lu", db.getConnection());
        ...
        {//Проверка на наличие незаполненных полей
            ...
            try
            {   // Формирование запроса
                MySqlCommand command = new MySqlCommand("insert into rabota(name_rab,date_extradition,date_delivery,id_obl,id_st) values(@n,@ex,@del,@id1,@id2);", db.getConnection());
                command.Parameters.Add("@n", MySqlDbType.VarChar).Value = Field1.Text;
                command.Parameters.Add("@ex", MySqlDbType.Date).Value = Field2.Text;
                command.Parameters.Add("@del", MySqlDbType.Date).Value = Field3.Text;
                command.Parameters.Add("@id1", MySqlDbType.Int32).Value = Field4.Text;
                command.Parameters.Add("@id2", MySqlDbType.Int32).Value = Field5.Text;
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            // Формирование запроса
            MySqlCommand command2 = new MySqlCommand("Select * From rabota ", db.getConnection());
        ...
        */
        ...
        {//Проверка на наличие незаполненных полей
            ...
            {
                // Формирование запроса
                MySqlCommand command = new MySqlCommand("update rabota set name_rab = @lu,date_extradition=@ex,date_delivery=@del,id_obl=@id1,id_st=@id2, where id_rab=@id", db.getConnection());
                command.Parameters.Add("@n", MySqlDbType.VarChar).Value = Field1.Text;
                command.Parameters.Add("@ex", MySqlDbType.Date).Value = Field2.Text;
                command.Parameters.Add("@del", MySqlDbType.Date).Value = Field3.Text;
                command.Parameters.Add("@id1", MySqlDbType.Int32).Value = Field4.Text;
       ...
       */
        ...
        {//Проверка на наличие незаполненных полей
            ...
            {
                // Формирование запроса
                MySqlCommand command = new MySqlCommand("delete from rabota where id_rab=@id2", db.getConnection());
