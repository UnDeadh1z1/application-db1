...
namespace proga1
{
    public partial class rukForm : Form
    {
        public rukForm()
        {
            InitializeComponent();
       ...
       */
        ...
        private void rukForm_Load(object sender, EventArgs e)
        {
            DB db = new DB();
            ...
            MySqlCommand command = new MySqlCommand("Select * From rukovod", db.getConnection());
        ...
        public Boolean checkUser()
        {
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            // Формирование запроса
            MySqlCommand command = new MySqlCommand("Select * From rukovod Where name_ruk = @lu", db.getConnection());
        ...
        {//Проверка на наличие незаполненных полей
            ...
            try
            { // Формирование запроса
                MySqlCommand command = new MySqlCommand("insert into rukovod(name_ruk) values(@n);", db.getConnection());
            ...
            MySqlDataAdapter adapter = new MySqlDataAdapter();
            // Формирование запроса
            MySqlCommand command2 = new MySqlCommand("Select * From rukovod ", db.getConnection());
        ...
        */
        ...
        {//Проверка на наличие незаполненных полей
            ...
            {
                // Формирование запроса
                MySqlCommand command = new MySqlCommand("update rukovod set name_ruk=@n where id_ruk=@id2", db.getConnection());
                command.Parameters.Add("@n", MySqlDbType.VarChar).Value = Field1.Text;
       ...
       */
        ...
        {//Проверка на наличие незаполненных полей
            ...
            {
                // Формирование запроса
                MySqlCommand command = new MySqlCommand("delete from rukovod where id_ruk=@id2", db.getConnection());
                command.Parameters.Add("@id2", MySqlDbType.Int32).Value = idField.Text;
                MySqlDataReader MyReader2;
                db.OpenConnection();
                MyReader2 = command.ExecuteReader();
